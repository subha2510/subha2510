...
public class Dice6 {
	...
	while(player1Position < WINNING_POSITION && player2Position < WINNING_POSITION) {
		if(player1Active) {
			int player1Dice = (int)(Math.floor(Math.random()*10)%6);
			...
			case SNAKE:
				...
				int player2Dice = (int)(Math.floor(Math.random()*10)%6);
				...
				case LADDER:
			         ...
			         break;
				case SNAKE:
					player1Position = player2Position - player2Dice;
				 ...
				 player1Active=opt2!=LADDER?false:true;  
	}
}
